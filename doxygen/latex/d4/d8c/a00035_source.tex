\hypertarget{a00035_source}{\section{emu\+\_\+data\+\_\+editor.\+cpp}
\label{a00035_source}\index{emu\+\_\+data\+\_\+editor.\+cpp@{emu\+\_\+data\+\_\+editor.\+cpp}}
}
...
00587 
00588              arg\_cnt = sscanf(line.toLatin1(),\textcolor{stringliteral}{"%u%*1c%u"},&time,&(\hyperlink{a00004_ab093b86d07b4eb96c36878089a7d97df}{edit\_point\_sets}[ii].val)
00589                               );
00590 
00591 
...
00749             !ui->\hyperlink{a00026_a1d46308dee8db7e3c99af65f13055479}{plot\_curve}->savePng(SelectedFilesName
00750                                     ,800,600))
00751                 ((\hyperlink{a00006}{MainWindow} *)parent())->msg(\hyperlink{a00034_aa8a990825a5a62c89d2fb8b08d8a1070}{MSG\_ERROR},\textcolor{stringliteral}{"Error: Couldn't save data"});
00752 
...
00757                    !ui->\hyperlink{a00026_a1d46308dee8db7e3c99af65f13055479}{plot\_curve}->saveBmp(SelectedFilesName
00758                                            ,800,600))
00759                        ((\hyperlink{a00006}{MainWindow} *)parent())->msg(\hyperlink{a00034_aa8a990825a5a62c89d2fb8b08d8a1070}{MSG\_ERROR},\textcolor{stringliteral}{"Error: Couldn't save
       data"});
00760 
00761      \}
00762 
00763     \}
00764      ui->\hyperlink{a00026_a1d46308dee8db7e3c99af65f13055479}{plot\_curve}->graph(0)->setPen(QPen(Qt::green));
00765 
...
00770      ui->\hyperlink{a00026_a1d46308dee8db7e3c99af65f13055479}{plot\_curve}->setColor(QColor(\textcolor{stringliteral}{"black"}));
00771      ui->\hyperlink{a00026_a1d46308dee8db7e3c99af65f13055479}{plot\_curve}->replot();
00772 
00773        \textcolor{keywordflow}{if}(!QDesktopServices::openUrl(QUrl(SelectedFilesName)))
00774            ((\hyperlink{a00006}{MainWindow} *)parent())->msg(\hyperlink{a00034_aa8a990825a5a62c89d2fb8b08d8a1070}{MSG\_ERROR},\textcolor{stringliteral}{"Couldn't open the file"}+
      SelectedFilesName);
00775 
00776 \}
\end{DoxyCode}
