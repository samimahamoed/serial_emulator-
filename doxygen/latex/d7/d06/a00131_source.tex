\hypertarget{a00131_source}{\section{settingsdialog.\+cpp}
\label{a00131_source}\index{settingsdialog.\+cpp@{settingsdialog.\+cpp}}
}
...
00089         ui->\hyperlink{a00082_aaf2756662f744e79aa3443f1e035870d}{descriptionLabel}->setText(tr(\textcolor{stringliteral}{"Description: %1"}).arg(list.at(1)));
00090         ui->\hyperlink{a00082_afeadc7657c9eaa3103bd529342f5fe97}{manufacturerLabel}->setText(tr(\textcolor{stringliteral}{"Manufacturer: %1"}).arg(list.at(2)));
00091         ui->\hyperlink{a00082_ad860892f11a79cb726643d3478078fcd}{locationLabel}->setText(tr(\textcolor{stringliteral}{"Location: %1"}).arg(list.at(3)));
00092         ui->\hyperlink{a00082_a50c8fdd36faae6146740e37728af71f2}{vidLabel}->setText(tr(\textcolor{stringliteral}{"Vendor Identifier: %1"}).arg(list.at(4)));
00093         ui->\hyperlink{a00082_a8ad53ddf3a11421d99dfa6fec8c92cfc}{pidLabel}->setText(tr(\textcolor{stringliteral}{"Product Identifier: %1"}).arg(list.at(5)));
00094     \}
00095 \}
00096 
...
00199     currentSettings.\hyperlink{a00075_aa962a6e7dbb8338af154305e4ff46cfc}{flowControl} = \textcolor{keyword}{static\_cast<}QSerialPort::FlowControl\textcolor{keyword}{>}(
00200                 ui->\hyperlink{a00082_a1ebdf5da704108eae1078cefc446fbef}{flowControlBox}->itemData(ui->\hyperlink{a00082_a1ebdf5da704108eae1078cefc446fbef}{flowControlBox}->currentIndex()
      ).toInt());
00201     currentSettings.\hyperlink{a00075_a1b0a388ec5059bd2628acf9b7728f2f3}{stringFlowControl} = ui->\hyperlink{a00082_a1ebdf5da704108eae1078cefc446fbef}{flowControlBox}->currentText();
00202 
00203     \textcolor{comment}{// Additional options}
00204     currentSettings.\hyperlink{a00075_ae1bfec3d6530f9791451d12aacfcb014}{localEchoEnabled} = ui->\hyperlink{a00082_a4cef19b8232e266ba202152ade600263}{localEchoCheckBox}->isChecked();
00205 \}
00206 
