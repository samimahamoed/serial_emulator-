\hypertarget{a00136_source}{\section{srv\+\_\+protocol.\+cpp}
\label{a00136_source}\index{srv\+\_\+protocol.\+cpp@{srv\+\_\+protocol.\+cpp}}
}
...
00064        \{
00065 
00066        sprintf(message,\textcolor{stringliteral}{"[%04X:%02X%02X:"},current\_cmd.\hyperlink{a00004_af20664dc9ca2b752c73d524edee0e07a}{cmd},current\_cmd.\hyperlink{a00004_a56e6c2d7315d0ae60a51e8b140c9cfe4}{arg}[0],current\_cmd.
      \hyperlink{a00004_a56e6c2d7315d0ae60a51e8b140c9cfe4}{arg}[1]);
00067 
00068        sprintf(message+11,\textcolor{stringliteral}{"%04X]"},\hyperlink{a00017_a09ae3cafdd3692fb9fb93bb90a0348d2}{crc16}((\hyperlink{a00004_a979e3e23b9a449e69ab6a8a83b6042f8}{Uint8}*)message,10));
00069 
00070 
00071 
...
00076        \{
00077     
00078        sprintf(message,\textcolor{stringliteral}{"[%04X:%02X%02X%04X%04X:"},current\_cmd.\hyperlink{a00004_af20664dc9ca2b752c73d524edee0e07a}{cmd},current\_cmd.
...
00080     
00081        sprintf(message+19,\textcolor{stringliteral}{"%04X]"},\hyperlink{a00017_a09ae3cafdd3692fb9fb93bb90a0348d2}{crc16}((\hyperlink{a00004_a979e3e23b9a449e69ab6a8a83b6042f8}{Uint8}*)message,18));
00082 
00083     
...
00093 
00094        sprintf(message,\textcolor{stringliteral}{"[%04X:%02X%02X%04X%04X"},current\_cmd.\hyperlink{a00004_af20664dc9ca2b752c73d524edee0e07a}{cmd},
...
00118 
00119        sprintf(message+var,\textcolor{stringliteral}{"%04X]"},\hyperlink{a00017_a09ae3cafdd3692fb9fb93bb90a0348d2}{crc16}((\hyperlink{a00004_a979e3e23b9a449e69ab6a8a83b6042f8}{Uint8}*)message,var-1));
00120 
00121 
00122 
00123 
...
00136                                     );
00137 
00138        sprintf(message+35,\textcolor{stringliteral}{"%04X]"},\hyperlink{a00017_a09ae3cafdd3692fb9fb93bb90a0348d2}{crc16}((\hyperlink{a00004_a979e3e23b9a449e69ab6a8a83b6042f8}{Uint8}*)message,34));
00139 
...
00145        \{
00146        sprintf(message,\textcolor{stringliteral}{"[%04X:%02X%02X%04X%04X%04X%04X:CCCC]"},current\_cmd.\hyperlink{a00004_af20664dc9ca2b752c73d524edee0e07a}{cmd},
...
00151 
00152 
00153        sprintf(message+27,\textcolor{stringliteral}{"%04X]"},\hyperlink{a00017_a09ae3cafdd3692fb9fb93bb90a0348d2}{crc16}((\hyperlink{a00004_a979e3e23b9a449e69ab6a8a83b6042f8}{Uint8}*)message,26));
00154 
...
00167                                     );
00168 
00169        sprintf(message+39,\textcolor{stringliteral}{"%04X]"},\hyperlink{a00017_a09ae3cafdd3692fb9fb93bb90a0348d2}{crc16}((\hyperlink{a00004_a979e3e23b9a449e69ab6a8a83b6042f8}{Uint8}*)message,38));
00170 
...
00176        \{
00177        sprintf(message,\textcolor{stringliteral}{"[%04X:%02X%02X%04X%04X%04X:CCCC]"},current\_cmd.\hyperlink{a00004_af20664dc9ca2b752c73d524edee0e07a}{cmd},
...
00182                                     );
00183 
00184        sprintf(message+23,\textcolor{stringliteral}{"%04X]"},\hyperlink{a00017_a09ae3cafdd3692fb9fb93bb90a0348d2}{crc16}((\hyperlink{a00004_a979e3e23b9a449e69ab6a8a83b6042f8}{Uint8}*)message,22));
00185 
...
00853             \}
00854             \}
00855             \textcolor{keywordflow}{if}((last\_cmd.\hyperlink{a00004_a2b48b371fd84be2a8ad581b1ad708b88}{vPos} < (multi\_cmds.length() - 1)))
00856                 last\_cmd.\hyperlink{a00004_a2b48b371fd84be2a8ad581b1ad708b88}{vPos}++;
...
00862 
00863 
00864             last\_cmd.\hyperlink{a00004_a56e6c2d7315d0ae60a51e8b140c9cfe4}{arg}[1] = multi\_cmds[last\_cmd.\hyperlink{a00004_a2b48b371fd84be2a8ad581b1ad708b88}{vPos}].address;
00865 
00866             multi\_cmds[last\_cmd.\hyperlink{a00004_a2b48b371fd84be2a8ad581b1ad708b88}{vPos}].gui.pBar->setValue(20);
00867 
...
00887 
00888 
00889 \textcolor{keywordtype}{bool} MainWindow::msg\_to\_mem(\textcolor{keywordtype}{char} * msg,\textcolor{keywordtype}{void}* dest,\hyperlink{a00004_aae7407b021d43f7193a81a58cfb3e297}{Uint16} size)\{
00890 
00891     \textcolor{keywordtype}{bool} result = \textcolor{keyword}{true};
00892     \textcolor{keywordflow}{try} \{
00893 
00894         \hyperlink{a00004_a979e3e23b9a449e69ab6a8a83b6042f8}{Uint8}* dst8= (\hyperlink{a00004_a979e3e23b9a449e69ab6a8a83b6042f8}{Uint8}*)dest;
00895         \hyperlink{a00004_aae7407b021d43f7193a81a58cfb3e297}{Uint16} cc   = 0;
00896 
00897         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} var = 0; var < size; ++var) \{
00898             *(dst8+var)= \hyperlink{a00017_aebce94d5e6af7afff661daf74b208de1}{make8}(msg,cc);
00899             cc +=2;
00900         \}
00901 
00902 
